...
// Add a global score variable
var score = 0;

// Add a scoreboard element to the page
function updateScoreboard() {
  ...
  if (!scoreboard) {
    ...
    scoreboard.style.padding = "8px 16px";
    scoreboard.style.font = "bold 18px sans-serif";
...
function showAnimatedMessage(text, color) {
  let msg = document.getElementById("animated-message");
  if (!msg) {
    ...
    msg.style.font = "bold 64px monospace";
    msg.style.color = color;
    msg.style.background = "rgba(0,0,0,0.8)";
    msg.style.padding = "40px 80px";
...
function updateTimer() {
  ...
  if (!timer) {
    ...
    timer.style.padding = "8px 16px";
    timer.style.font = "bold 18px sans-serif";
    timer.style.zIndex = 1000;
    document.body.appendChild(timer);
  }
  let min = Math.floor(timeLeft / 60);
  let sec = timeLeft % 60;
  timer.textContent = `Time: ${min}:${sec < 10 ? "0" : ""}${sec}`;
}
